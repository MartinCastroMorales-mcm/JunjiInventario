...
def add_estado_equipo():
    if request.method == 'POST':
       # idasignacion = request.form['idasignacion']
        ...
        try:
            cur = mysql.connection.cursor()
            cur.execute('INSERT INTO asignacion (fecha_inicioAsignacion,ObservacionAsignacion,rutaactaAsignacion,ActivoAsignacion,rutFuncionario,idEquipo) VALUES (%s, %s,%s,%s,%s,%s)', 
                        ( fechaasignacion,observacionasignacion,rutaactaasignacion,Activoasignacion,rutFuncionario,idequipo))
...
def update_asignacion(id):
    if request.method == 'POST':
        ...
        try:
            ...
            """, (fechaasignacion, observacionasignacion,rutaactaasignacion,ActivoAsignacion,rutFuncionario,idequipo,id))
            mysql.connection.commit()
